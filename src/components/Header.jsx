  ...
  return (
    <header className="bg-white border-b border-slate-200 px-4 py-2.5 flex items-center justify-between shadow-sm z-30 select-none">
      ...
      <div className="flex items-center space-x-3">
        <div className="h-11 px-2 py-1 rounded-xl bg-white border border-slate-200 flex items-center justify-center shadow-sm">
          <img
        ...
        <div>
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[10px] uppercase font-black tracking-wider px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-800 border border-emerald-300">
              3-Sleeve Spec
            </span>
          </div>
          <p className="text-xs text-slate-500 font-semibold">
            Radiance Polymer • Shop Floor Quality Control
          </p>
        </div>
      </div>
